      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-2 mx-auto ">
        ...
        <div className="text-center space-y-8">
          ...
          <Badge variant="outline" className="text-sm py-2 bg-white">
            ...
            <span className="inline-flex items-center text-black gap-1.5">
        ...
        <div className="relative mt-16 ">
          ...
          <div className="absolute top-2 lg:-top-8  left-1/2 transform -translate-x-1/2 w-[70%]  mt-16 mx-auto h-24 lg:h-50 bg-primary/50 blur-2xl"></div>
