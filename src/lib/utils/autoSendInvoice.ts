          ...
          <div style="margin-bottom: 16px; display: flex; align-items: center; gap: 16px;">
            <div>
              <div style="font-size: 14px; color: #6b7280; margin-bottom: 4px;">
                Issued on ${formatDate((invoice.issueDate || invoice.createdAt || '') as string)}
              </div>
              <div style="font-size: 14px; color: #6b7280;">
                Payment due by ${formatDate((invoice.dueDate || '') as string)}
              </div>
        ...
        <div style="width: 256px;">
          ...
          ${(invoice.totalTax || 0) > 0 ? `
            <div style="display: flex; justify-content: space-between; color: #6b7280; font-size: 14px; margin-bottom: 8px;">
              ...
              <span>${getCurrencySymbol()}${(invoice.totalTax || 0).toFixed(2)}</span>
            </div>
          ` : ''}
    ...
    <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
      <div style="font-size: 12px; color: #9ca3af; line-height: 1.5;">
        ...
        <div style="margin-bottom: 8px; font-size: 11px;">
          Invoice Number: ${invoice.invoiceNumber || 'N/A'} | Date: ${formatDate((invoice.issueDate || invoice.createdAt || '') as string)}
        </div>
